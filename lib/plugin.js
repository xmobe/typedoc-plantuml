...
function plugin (pluginHost, cb) {
    ...
    app.converter.on("resolveEnd", function (context) {
        ...
        autoClassDiagramType = app.options.getValue("umlClassDiagramType");
        if (autoClassDiagramType) {
            autoClassDiagramType = autoClassDiagramType.toLowerCase();
        }
        if (autoClassDiagramType != "none" && autoClassDiagramType != "simple" && autoClassDiagramType != "detailed") {
            autoClassDiagramType = "none";
        }

        // more options regarding the automatic generation of class diagrams
        if (autoClassDiagramType != "none") {
            ...
            if (autoClassDiagramHideEmptyMembers != "true" && autoClassDiagramHideEmptyMembers != "false") {
                autoClassDiagramHideEmptyMembers = "true";
            }
            ...
            if (!autoClassDiagramTopDownLayoutMaxSiblings) {
                autoClassDiagramTopDownLayoutMaxSiblings = 6;
            }
        }
        ...
        for (var key in project.reflections) {
            ...
            if(reflection.comment) {
                ...
                if (autoClassDiagramType != "none" && (reflection.kind == 128 || reflection.kind == 256)) {
     ...
     * @param {DeclarationReflection[]} reflections The array from which duplicates should be removed.
     * @returns {DeclarationReflection[]} The new array without duplicates.
     */
     ...
     * @param {DeclarationReflection} reflection The reflection whoes parent types are wanted.
     * @returns {DeclarationReflection[]} The reflections the given reflection is extending or implementing.
     */
     ...
     * @param {DeclarationReflection} reflection The reflection whoes sub types are wanted.
     * @returns {DeclarationReflection[]} The reflections the given reflection is extended by or implemented by.
     */
     ...
     * @param {DeclarationReflection} reflection The reflection whoes extended types are wanted.
     * @returns {DeclarationReflection[]} The reflections the given reflection is extending.
     */
     ...
     * @param {DeclarationReflection} reflection The reflection whoes sub types are wanted.
     * @returns {DeclarationReflection[]} The reflections that are extending the given reflection.
     */
     ...
     * @param {DeclarationReflection} reflection The reflection whoes implemented types are wanted.
     * @returns {DeclarationReflection[]} The reflections the given reflection is implementing.
     */
     ...
     * @param {DeclarationReflection} reflection The reflection whoes implementations are wanted.
     * @returns {DeclarationReflection[]} The reflections that are implementing the given reflection.
     */
     ...
     * @param {DeclarationReflection} property The property for which the PlantUML should be generated.
     * @returns {string} The PlantUML line for the given property.
     */
    function getPlantUmlForProperty(property) {
        var plantUml = "";
     ...
     * @param {DeclarationReflection} methode The method for which the PlantUML should be generated.
     * @returns {string} The PlantUML line for the given method.
     */
    function getPlantUmlForMethod(method) {
        var plantUml = "";
        ...
        plantUml += " : ";
        plantUml += method.type ? method.type.name : "void";
     ...
     * @param {DeclarationReflection} reflection The class or interface for which the PlantUML should be generated.
     * @returns {string} The PlantUML line for the given class or interface.
     */
    function getPlantUmlForClassOrInterface(reflection) {
        var plantUml = "";
     ...
     * @param {DeclarationReflection} reflection The reflection for which the PlantUML should be generated.
     * @returns {string[]} The PlantUML lines for the given type.
     */
    function getPlantUmlForReflection(reflection) {
        var plantUmlLines = [];

        // class or interface?
        if (reflection.kind == 128 || reflection.kind == 256) {
            plantUmlLines.push(getPlantUmlForClassOrInterface(reflection) + " {");

            if (autoClassDiagramType == "detailed" && reflection.children) {
                for (var i = 0; i < reflection.children.length; ++i) {
                    if (reflection.children[i].kind == 1024) { // property
                        plantUmlLines.push(getPlantUmlForProperty(reflection.children[i]));
                    } else if (reflection.children[i].kind == 2048) { // method
                        plantUmlLines.push(getPlantUmlForMethod(reflection.children[i]));
                    }
                }
            }
     ...
     * @param {DeclarationReflection} reflection The reflection whoes comment is extended.
     */
    function addClassDiagramPlantUmlToComment(reflection) {
        ...
        // add class/interface
        plantUmlLines = plantUmlLines.concat(getPlantUmlForReflection(reflection));
        ...
        for (var i = 0; i < extendedTypes.length; ++i) {
            plantUmlLines = plantUmlLines.concat(getPlantUmlForReflection(extendedTypes[i]));
        ...
        for (var i = 0; i < implementedTypes.length; ++i) {
            plantUmlLines = plantUmlLines.concat(getPlantUmlForReflection(implementedTypes[i]));
        ...
        for (var i = 0; i < extendedBys.length; ++i) {
            plantUmlLines = plantUmlLines.concat(getPlantUmlForReflection(extendedBys[i]));
        ...
        for (var i = 0; i < implementedBys.length; ++i) {
            plantUmlLines = plantUmlLines.concat(getPlantUmlForReflection(implementedBys[i]));
        ...
        if (siblingsAbove + siblingsBelow > 0) {
            ...
            if (autoClassDiagramHideEmptyMembers == "true") {
                plantUmlLines.splice(1, 0, "hide empty fields");
                plantUmlLines.splice(1, 0, "hide empty methods");
            }
